...
# Upstream ships a prebuilt Electron bundle; runtime shared libraries are the
...
src_install() {
	# Install the prebuilt Electron bundle to /opt.
	dodir /opt
	...
	# Desktop entry and icons (upstream names the entry after the app-id).
